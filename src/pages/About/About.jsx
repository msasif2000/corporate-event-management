...
const About = () => {
    return (
        <div>
            <Header></Header>
            <Navbar></Navbar>
            <div className="my-12 mx-24 md:flex gap-3 items-center"> 
                <p className=" border-2 p-3  rounded-lg">At <span className="font-bold text-xl text-orange-600">Corporate Event Management</span>, we are dedicated to crafting unforgettable experiences that go beyond the ordinary. With a passion for perfection and an unwavering commitment to excellence, we specialize in curating corporate events that leave a lasting impression. Our team of seasoned professionals brings creativity, precision, and attention to detail to every project, ensuring that each event is unique, seamless, and tailored to your company`s vision.
                    ...
                    <img src={gif1} alt=""  className="w-[400px] h-[400px] rounded-lg"/>
            </div>
        </div>
    );
};
