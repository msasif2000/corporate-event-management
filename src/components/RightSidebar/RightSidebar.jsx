    ...
    return (
        <div className="pr-2 rounded bg-gradient-to-r md:grid md:grid-cols-2 lg:grid-cols-1 from-orange-100 from-10% via-sky-100 via-30% to-emerald-100 to-90% ...">
            ...
            <div>
                ...
                <div className="my-2 pb-8 mx-2">
                    <a href="+1 (456) 789-0123" className="flex items-center gap-2  border rounded-t-lg ">
                        <FaWhatsapp className="text-xl text-green-500"></FaWhatsapp>
                        Whatsapp
                    </a>
                    <a href="" className="flex items-center gap-2  border-x ">
                        <FaMobileAlt className="text-xl text-blue-500"></FaMobileAlt>
                        +1 (456) 789-0123
                    </a>
                    <a href="https://corporate.e.m.@gmail.com/" className="flex items-center gap-2  border rounded-b-lg ">
